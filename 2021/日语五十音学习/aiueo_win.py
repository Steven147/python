...
l2.pack()
#第一个按键 产生新的组合
b = tkinter.Button(windows, text = 'NEW!', font=('Arial, 30'), width = 20, height=2, command=botton1)
b.pack()
#第二个按键 显示答案
b2 = tkinter.Button(windows, text = "Answer?", font=('Arial, 30'), width = 20, height=2, command=botton2)
b2.pack()
#第三个按键 开关答案显示和隐藏
